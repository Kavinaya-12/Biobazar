...
const Foods = () => {
  ...
  const { foods, filteredProducts } = useSelector((state) => state.products);
  ...
  const productsToShow = filteredProducts?.length ? filteredProducts : foods;
 ...
 <div className="foods-container">
  ...
  <div className="foods-grid">
    {productsToShow.map((product) => {
      ...
      const isInWishlist = wishlist.some((i) => i._key === _key);
      return (
        <div key={_key} className="foods-card">
